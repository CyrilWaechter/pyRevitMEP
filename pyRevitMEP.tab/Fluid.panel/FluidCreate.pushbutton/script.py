...
fluid_list = {'Pure':
                  ('1-Butene', 'Acetone', 'Air', 'Ammonia', 'Argon', 'Benzene', 'CarbonDioxide', 'CarbonMonoxide',
                   ...
                   'Xenon'),
              'Incompressible : Pure':
                  ("AS10", "AS20", "AS30", "AS40", "AS55", "DEB", "DowJ", "DowJ2", "DowQ", "DowQ2", "HC10", "HC20",
                   "HC30", "HC40", "HC50", "HCB", "HCM", "HFE", "HFE2", "HY20", "HY30", "HY40", "HY45", "HY50", "NBS",
                   "NaK", "PBB", "PCL", "PCR", "PGLT", "PHE", "PHR", "PLR", "PMR", "PMS1", "PMS2", "PNF", "PNF2",
                   "S800", "SAB", "T66", "T72", "TCO", "TD12", "TVP1", "TVP1869", "TX22", "TY10", "TY15", "TY20",
                   "TY24", "Water", "XLT", "XLT2", "ZS10", "ZS25", "ZS40", "ZS45", "ZS55"),
              'Incompressible : Mixtures (vol)':
                  ("AEG", "AKF", "AL", "AN", "APG", "GKN", "PK2", "PKL", "ZAC", "ZFC", "ZLC", "ZM", "ZMC"),
              'Incompressible : Mixtures (%)':
                  ("FRE", "IceEA", "IceNA", "IcePG", "LiBr", "MAM", "MAM2", "MCA", "MCA2", "MEA", "MEA2", "MEG", "MEG2",
                   "MGL", "MGL2", "MITSW", "MKA", "MKA2", "MKC", "MKC2", "MKF", "MLI", "MMA", "MMA2", "MMG", "MMG2",
                   "MNA", "MNA2", "MPG", "MPG2", "VCA", "VKC", "VMA", "VMG", "VNA")
              }
